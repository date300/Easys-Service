...
// ==================== PRODUCT DETAILS PAGE (UPDATED - Matching Main App Design) ====================
...
class _ProductDetailsPageState extends State<ProductDetailsPage>
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'প্রতিটি প্রোডাক্টে upto ৳${maxProfit.toInt()} পর্যন্ত মার্জিন পেতে পারেন',
                  style: GoogleFonts.poppins(
                    fontSize: 12.sp,
  ...
  Widget _buildDeliveryInfo(bool isDark, Color cardBg, Color kTextDark, Color kTextMid, Color borderColor, Color shadowColor) {
    final items = [
      _InfoRow(icon: CupertinoIcons.location, color: const Color(0xFF34C759), title: 'ডেলিভারি', value: 'ঢাকা ১-২ দিন, ঢাকার বাইরে ২-৪ দিন'),
      _InfoRow(icon: CupertinoIcons.return_icon, color: const Color(0xFF29B6F6), title: 'রিটার্ন', value: '৭ দিনের মধ্যে ফ্রি রিটার্ন সুবিধা'),
      _InfoRow(icon: CupertinoIcons.shield_fill, color: const Color(0xFF6366F1), title: 'ওয়ারেন্টি', value: '১ বছর অফিসিয়াল ওয়ারেন্টি'),
      _InfoRow(icon: CupertinoIcons.checkmark_seal, color: const Color(0xFFFF9500), title: 'গ্যারান্টি', value: '১০০% অথেনটিক প্রোডাক্ট গ্যারান্টি'),
    ];
  ...
  Widget _buildHighlights(bool isDark, Color cardBg, Color kTextDark, Color kTextMid, Color borderColor, Color shadowColor) {
    final highlights = [
      '✓ প্রিমিয়াম কোয়ালিটি ম্যাটেরিয়াল দিয়ে তৈরি',
      '✓ ব্লুটুথ ৫.৩ এবং টাচ কন্ট্রোল',
      '✓ দীর্ঘ ব্যাটারি লাইফ',
      '✓ ফাস্ট চার্জিং সাপোর্ট',
      '✓ ওয়াটারপ্রুফ ডিজাইন সহ আসে',
    ];
  ...
  Widget _buildDescription(bool isDark, Color cardBg, Color kTextDark, Color kTextMid, Color borderColor, Color shadowColor) {
    const fullDesc =
        'এই প্রিমিয়াম কোয়ালিটি প্রোডাক্টটি আমাদের বিশেষ কালেকশন থেকে নির্বাচিত। এটি সর্বোচ্চ মানের ম্যাটেরিয়াল দিয়ে তৈরি এবং দীর্ঘস্থায়ী পারফরম্যান্সের জন্য ডিজাইন করা হয়েছে। '
        'প্রোডাক্টটি ব্যবহারকারীদের জন্য সর্বোত্তম কমফোর্ট এবং স্টাইল নিশ্চিত করে। এটি আপনার দৈনন্দিন জীবনে একটি নতুন অভিজ্ঞতা যোগ করবে। '
        'আমরা গ্যারান্টি দিচ্ছি যে এই প্রোডাক্টটি আপনার প্রত্যাশা পূরণ করবে এবং তারচেয়েও বেশি।';
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Row(
              children: [
                Text(
                  _showFullDescription ? 'কম দেখুন' : 'আরো দেখুন',
                  style: GoogleFonts.poppins(
                    fontSize: 12.sp,
                    color: const Color(0xFF29B6F6),
                    fontWeight: FontWeight.w600,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    Text(
                      '⭐ 4.9 | 2.3k+ ফলোয়ার্স | 98% পজিটিভ রেটিং',
                      style: GoogleFonts.poppins(fontSize: 11.sp, color: kTextMid),
                    ),
                  ],
                ),
  ...
  Widget _buildRatings(bool isDark, Color cardBg, Color kTextDark, Color kTextMid, Color borderColor, Color shadowColor) {
    final reviews = [
      _Review(name: 'রাহুল আহমেদ', rating: 5, text: 'অসাধারণ পণ্য! ভালো কোয়ালিটি, দ্রুত ডেলিভারি', time: '২ দিন আগে'),
      _Review(name: 'সাবা খান', rating: 4, text: 'প্রোডাক্ট ভালো কিন্তু প্যাকেজিং আরও উন্নত হতে পারত', time: '১ সপ্তাহ আগে'),
      _Review(name: 'তানভীর হাসান', rating: 5, text: 'দারুণ সার্ভিস এবং অরিজিনাল প্রোডাক্ট', time: '৩ সপ্তাহ আগে'),
    ];
