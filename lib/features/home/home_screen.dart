...
// নিশ্চিত হোন যে main.dart থেকে এই প্রোভাইডারগুলো ইমপোর্ট করা আছে
import '../../main.dart'; 
...
final servicesProvider = Provider<List<Service>>((ref) {
  return const [
    ...
    Service(name: 'Campaign', icon: CupertinoIcons.speaker_2, color: Color(0xFF7C3AED), secondaryColor: Color(0xFFA78BFA), route: '/campaigns', requiresVerification: true),
...
// ConsumerWidget এ কনভার্ট করা হয়েছে যাতে রিভারপড ব্যবহার করা যায়
class _ServiceCard extends ConsumerWidget {
  ...
  void _navigateToDetail(BuildContext context, WidgetRef ref) {
    // ১. স্টেট আপডেট করা (সব পেজের জন্য ডিটেইল ভিউ এনাবেল করা)
